...
object SettingsHeadsetHook : HookContext() {
    ...
    private fun requestBluetoothStatus(reason: String) {
        ...
        listOf(HyperPodsAction.ACTION_PODS_UI_INIT, HyperPodsAction.ACTION_REFRESH_STATUS).forEach { action ->
    ...
    private fun sendOppoAnc(mode: Int) {
        ...
        ctx.sendBroadcast(Intent(HyperPodsAction.ACTION_ANC_SELECT).apply {
