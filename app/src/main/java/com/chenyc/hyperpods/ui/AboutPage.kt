...
import com.chenyc.hyperpods.ui.effect.BgEffectBackground
import com.chenyc.hyperpods.ui.effect.ColorBlendToken
...
fun SettingsPage(
    ...
    val temporaryBatteryIslandDurationOptions =
        HyperPodsPrefsKey.TEMPORARY_BATTERY_ISLAND_DURATION_SECOND_OPTIONS
...
fun AdvancedSettingsPage(
    ...
    showConnectionPopup: MutableState<Boolean> =
        mutableStateOf(HyperPodsPrefsKey.DEFAULT_SHOW_CONNECTION_POPUP),
    onShowConnectionPopupChange: (Boolean) -> Unit = {},
    connectionPopupDismissSeconds: MutableState<Int> =
        mutableStateOf(HyperPodsPrefsKey.DEFAULT_CONNECTION_POPUP_DISMISS_SECONDS),
    onConnectionPopupDismissSecondsChange: (Int) -> Unit = {},
    milinkSpatialAudioOptionEnabled: MutableState<Boolean> =
        mutableStateOf(HyperPodsPrefsKey.DEFAULT_MILINK_SPATIAL_AUDIO_OPTION_ENABLED),
    ...
    val popupDismissSecondOptions = HyperPodsPrefsKey.CONNECTION_POPUP_DISMISS_SECOND_OPTIONS
    ...
    val popupDismissSecondSelectedIndex = popupDismissSecondOptions
        ...
        .takeIf { it >= 0 }
        ?: popupDismissSecondOptions.indexOf(HyperPodsPrefsKey.DEFAULT_CONNECTION_POPUP_DISMISS_SECONDS)
                ...
                Column(
                    ...
                    Card(
                        ...
                        ArrowPreference(
                            ...
                            onClick = { uriHandler.openUri("https://github.com/huime180/HyperPods") }
                        )
                    }
